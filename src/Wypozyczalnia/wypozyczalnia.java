...
static JFrame wypozyczalnia;
    public wypozyczalnia() throws SQLException {
        ...
        try(Connection Con = DB.getConnection()) {
            ...
            PreparedStatement ps=Con.prepareStatement("select * from wypozyczalnia",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_wypozyczenia", "ID_samochodu", "Data_godzina_wypozyczenia", "Termin_zwrotu", "Data_zwrotu", "Kaucja",
            }
        ) {
